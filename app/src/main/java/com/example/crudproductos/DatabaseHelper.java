...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void insertarProducto(String nom,String des, double precio, int stock, String url) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COLUMN_NOMBRE, nom);
        values.put(COLUMN_DESCRIP, des);
    ...
    public int actualizarProducto(int id, String nom,String des, double precio, int stock, String url) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
